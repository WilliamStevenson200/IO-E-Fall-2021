...
function draw() {
  ...
  background(diameter2 *40,diameter2 *40,0);
  text(latestData, 10,10);
  ellipseMode(RADIUS);    
  fill(diameter2*20,diameter2*20,0);
  noStroke(); 
  //console.log("diameter0  "  + diameter0);
  ellipse(700, diameter1, diameter2*2, diameter2*2);
  ellipseMode(RADIUS);    
  
  ellipse(diameter1, diameter1, diameter2*2, diameter2*2);
  ellipseMode(RADIUS);
  ellipse(diameter1, 500, diameter2*2, diameter2*2);
  
    
  
  var freq = map(diameter0 *100, 0, width, 40, 880);    
    osc1.freq(freq);

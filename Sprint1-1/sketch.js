...
function draw() {
  ...
  background(diameter0 *255,diameter0 *255,diameter0*255);
  text(latestData, 10,10);
  ellipseMode(RADIUS);    
  fill(diameter1,0,0);
  noStroke(); 
  //console.log("diameter0  "  + diameter0);
  ellipse(700, 400, diameter2*2, diameter2*2);
  ellipseMode(RADIUS);    
  fill(0,diameter1, 0);
  ellipse(1100, 400, diameter2*2, diameter2*2);
  ellipseMode(RADIUS);
  fill(0, 0,diameter1);
  ellipse(300, 400, diameter2 * 2, diameter2*2);
